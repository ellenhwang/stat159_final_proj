...
It is not difficult to observe that ridge regression has the lowest MSE value out of all regressions. Below is the regression coefficients from ridge regression.
