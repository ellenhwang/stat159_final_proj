...
print(cor_tab, comment = FALSE, table.placement = 'H', type = 'html', caption.placement = 'top')
```
## Analysis -cont
...
print(mse_table, comment = FALSE, table.placement = 'H', type = 'html', caption.placement = 'top')
```
```{r , results = "asis", fig = TRUE, include =TRUE, echo = FALSE, eval=TRUE}
...
print(tops, comment = FALSE, table.placement = 'H', type = 'html', caption.placement = 'top')
